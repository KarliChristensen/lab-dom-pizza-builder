...
function renderGlutenFreeCrust() {
  document.querySelectorAll('.crust-gluten-free').forEach((onePep) => {
...
function renderPrice() {
  ...
  $list.innerHTML = "";
  Object.entries(ingredients).forEach(([ingredientKey, { price, name }]) => {
    if (state[ingredientKey]) {
      totalPrice += price;
      $list.innerHTML += `<li>$${price} ${name.toLowerCase()}</li>`;
    }
  });
